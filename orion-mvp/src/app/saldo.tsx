    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceAmount}>
            <Text style={styles.balanceCurrency}>B/. </Text>12.50
          </Text>
          <Text style={styles.cardNumber}>Tarjeta •••• 4821</Text>
        ...
        <View style={styles.txRow}>
          <View style={styles.txLeft}>
            ...
            <View>
              ...
              <Text style={styles.txDate}>Hoy · 8:14 am · Sincronizada</Text>
            </View>
          </View>
          <Text style={styles.txAmount}>+B/.10.00</Text>
        </View>
        ...
        <View style={styles.txRow}>
          <View style={styles.txLeft}>
            ...
            <View>
              <Text style={styles.txInfo}>Recarga digital</Text>
              <Text style={styles.txDate}>Ayer · 5:30 pm · Sincronizada</Text>
            </View>
          </View>
          <Text style={styles.txAmount}>+B/.5.00</Text>
        </View>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem}>
          ...
          <Text style={[styles.navItemText, styles.navItemActive]}>Tarjeta</Text>
...
const styles = StyleSheet.create({
  ...
  badge: {
    ...
    backgroundColor: 'rgba(200,212,0,0.15)',
    borderWidth: 0.5,
    borderColor: '#C8D400',
    borderRadius: 20,
